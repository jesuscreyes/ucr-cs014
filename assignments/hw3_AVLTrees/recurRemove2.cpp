    ...
    if(tempRoot->val == s){
        ...
        if(tempRoot->p != NULL){
            ...
            if(tempRoot->p->l == tempRoot){
                cout << "XXXXX!!!: Current node is left child of parent" << endl;
                cout << "Current node's parent: " << tempRoot->p->val << endl;
                if(getHeight(tempRoot->l) > getHeight(tempRoot->r)){
                    cout << "Left child moves up" << endl;
                    tempRoot->p->l = tempRoot->l;
                    tempRoot->l->p = tempRoot->p;
                    tempRoot->r->p = tempRoot->l;
                    
                }
                else if(getHeight(tempRoot->l) <= getHeight(tempRoot->r)){
                    cout << "Right child moves up" << endl;
                }
                else{
